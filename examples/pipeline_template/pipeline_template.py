...
project_name = 'excitonic_gate_mols'

# tag = ["symmetric_azulene_gen1"]

# addsmiles sf_lib /home/denn/harvard/SF/Library/Reaxys/reaxys5_dicyanoanth.smi -t reaxys5 --settings djangochem.settings.denn
...
while True:
    ...
    call_command('requestjobs', project_name, 'b3lyp_6-31gs_opt_qchem', parent_config='conformer', limit=LIMIT)
