...
MAX_SPOOLED_SIZE = getattr(settings, 'DBBACKUP_MAX_SPOOLED_SIZE', 250 * 1024 * 1024)
...
BACKUP_TEMP_DIRECTORY = getattr(settings, 'DBBACKUP_BACKUP_TEMP_DIRECTORY', "/tmp")
...
MONGO_BACKUP_COMMANDS = getattr(settings, 'DBBACKUP_MONGO_BACKUP_COMMANDS', None)
MONGO_RESTORE_COMMANDS = getattr(settings, 'DBBACKUP_MONGO_RESTORE_COMMANDS', None)
